...
tools.add({
    ...
    simpleDescription: {
        en: "Reads HubSpot CRM objects (Companies, Contacts, Deals), their object associations (Deal-Company, Deal-Contact, Contact-Company), their associated activities (calls, emails, notes, meetings, tasks), and account users, including custom properties",
        de: "Liest HubSpot CRM Objekte (Unternehmen, Kontakte, Deals), deren Objektverknüpfungen (Deal-Unternehmen, Deal-Kontakt, Kontakt-Unternehmen), deren zugehörige Aktivitäten (Anrufe, E-Mails, Notizen, Meetings, Aufgaben) sowie Account-Benutzer, einschließlich benutzerdefinierter Eigenschaften"
    },
    args: [
        {
            key: "baseUrl",
